...
<head>
    ...
    <!-- icheck bootstrap -->
    <link rel="stylesheet" href="{{ asset('demo/css/icheck-bootstrap.min.css') }}">
    <!-- Theme style -->
    ...
    <div class="card">
        <div class="card-body register-card-body">
            ...
            <form action="{{ route('register') }}" method="POST">
                ...
                <div class="input-group mb-3">
                    <input type="password" class="form-control @error('email') is-invalid @enderror" placeholder="Password">
                    <div class="input-group-append">
                        <div class="input-group-text">
